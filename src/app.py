...
activities = {
    ...
    "Music Ensemble": {
        "description": "Perform in orchestra and chamber music groups",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["liam@mergington.edu", "mia@mergington.edu"]
    },
    "Debate Club": {
        "description": "Master argumentation and public speaking skills",
        "schedule": "Mondays, 3:30 PM - 4:45 PM",
        "max_participants": 14,
        "participants": ["noah@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Compete in Science Olympiad tournaments and events",
